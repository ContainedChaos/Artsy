...
const artImage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, "uploads/artImage");
  },
...
let uploadArtImage = multer({ storage: artImage, fileFilter, limits: {
...
module.exports = { uploadArtImage, uploadAudioFile, uploadVideoFile, uploadFile };
